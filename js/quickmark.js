...
//
  ...
  newNode.id = 'content';
  document.body.replaceChild(newNode, xmpTag)
...
//
  ...
  if (data.preview == 'true') {
    document.querySelector('#style').innerHTML = '*, *::before, *::after {max-width: 480px; width: 480px; box-sizing: border-box; margin: 0; font-size: 1em;}'
  }
  // All done - show body
